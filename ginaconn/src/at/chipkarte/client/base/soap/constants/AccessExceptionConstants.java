...
public final class AccessExceptionConstants {
  ...
  /**
   * Diese Exception tritt auf, wenn eine Funktion aufgerufen wird, für die das Recht 'EBS.CORE' Voraussetzung ist. <br>
   * ORCLI-Code: CL-A0005
   */
  public static final int MISSING_EBS_CORE = 34;
  
  /**
   * Diese Exception tritt auf, wenn eine Funktion aufgerufen wird, für die das Recht 'EBS.ANTRAG' Voraussetzung ist. <br>
   * ORCLI-Code: CL-A0005
   */
  public static final int MISSING_EBS_ANTRAG = 35;
  
  /**
   * Diese Exception tritt auf, wenn eine Funktion aufgerufen wird, für die das Recht 'EBS.UEBERNAHME' Voraussetzung ist. <br>
   * ORCLI-Code: CL-A0005
   */
  public static final int MISSING_EBS_UEBERNAHME = 36;
  
  /**
   * Diese Exception tritt auf, wenn eine Funktion aufgerufen wird, für die das Recht 'BKF.LA_ABFRAGE' Voraussetzung ist. <br>
   * ORCLI-Code: CL-A0005
   */
  public static final int MISSING_BKF_LA_ABFRAGE = 37;
  
  /**
   * Diese Exception tritt auf, wenn eine Funktion aufgerufen wird, für die das Recht 'BKF.MAMMO' oder 'BKF.ASSESSMENT' Voraussetzung ist. <br>
   * ORCLI-Code: CL-A0005
   */
  public static final int MISSING_BKF_MAMMO_OR_ASSESSMENT = 38;
  /**
   * Diese Exception tritt auf, wenn eine Funktion aufgerufen wird, für die das Recht 'ELGATSV.CORE' Voraussetzung ist. <br>
   * ORCLI-Code: CL-A0005
   */
  public static final int MISSING_ELGATSV_CORE = 39;
  /**
   * Diese Exception tritt auf, wenn eine Funktion aufgerufen wird, für die das Recht 'ELGAAD.CORE' Voraussetzung ist. <br>
   * ORCLI-Code: CL-A0005
   */
  public static final int MISSING_ELGAAD_CORE = 40;
  /**
   * Diese Exception tritt auf, wenn eine Funktion aufgerufen wird, für die das Recht 'ELGAAD.AUTH' Voraussetzung ist. <br>
   * ORCLI-Code: CL-A0005
   */
  public static final int MISSING_ELGAAD_AUTH = 41;
  /**
   * Diese Exception tritt auf, wenn eine Funktion aufgerufen wird, für die das Recht 'ELGAAD.MEDIKATION' Voraussetzung ist. <br>
   * ORCLI-Code: CL-A0005
   */
  public static final int MISSING_ELGAAD_MEDIKATION = 42;
  /**
   * Diese Exception tritt auf, wenn eine Funktion aufgerufen wird, für die das Recht 'ELGAAD.BEFUND' Voraussetzung ist. <br>
   * ORCLI-Code: CL-A0005
   */
  public static final int MISSING_ELGAAD_BEFUND = 43;
  /**
   * Diese Exception tritt auf, wenn eine Funktion aufgerufen wird, für die das Recht 'FUS.CORE' Voraussetzung ist. <br>
   * ORCLI-Code: CL-A0005
   */
  public static final int MISSING_FUS_CORE = 44;
  /**
   * Diese Exception tritt auf, wenn eine Funktion aufgerufen wird, für die das Recht 'FUS.VP' Voraussetzung ist. <br>
   * ORCLI-Code: CL-A0005
   */
  public static final int MISSING_FUS_VP = 45;
  /**
   * Diese Exception tritt auf, wenn eine Funktion aufgerufen wird, für die das Recht 'FUS.WP' Voraussetzung ist. <br>
   * ORCLI-Code: CL-A0005
   */
  public static final int MISSING_FUS_WP = 46;
  /**
   * Diese Exception tritt auf, wenn eine Funktion aufgerufen wird, für die das Recht 'FUS.EK' Voraussetzung ist. <br>
   * ORCLI-Code: CL-A0005
   */
