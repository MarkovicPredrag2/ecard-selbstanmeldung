...
public final class CardExceptionConstants {
   ...
   * Funktion
   * {@link at.chipkarte.client.base.soap.IBaseService#changePinWithPuk(String, String, String, String) changePinWithPuk} 
   ...
   * {@link at.chipkarte.client.base.soap.IBaseService#changePin(String, String, String, String) changePin} 
  ...
  /**
   * Es ist die falsche Ordinationskarte (Admin-Karte) gesteckt. Sie haben sich mit der
   * Ordinationskarte (Admin-Karte) eines anderen Vertragspartners angemeldet.
