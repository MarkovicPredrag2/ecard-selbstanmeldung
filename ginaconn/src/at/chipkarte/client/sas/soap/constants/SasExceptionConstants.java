...
public final class SasExceptionConstants {
  ...
  /**
   * Zu den eingegebenen Suchkriterien konnte keine Person gefunden werden, f�r die eine e-card ausgestellt wurde.<br>
   * ORCLI-Code: ZS-08001
   */
  ...
  /**
   * Das Backend-Auskunftsservice steht derzeit nicht zur Verf�gung. Bitte versuchen Sie es zu einem sp�teren Zeitpunkt erneut.<br>
   * ORCLI-Code: ZS-08005
   */
  public static final int BACKENDSYSTEM_NOT_AVAILABLE = 5;
  /**
   * Bei der Ermittlung der Adressdaten ist im Backend ein technischer Fehler aufgetreten. Bitte versuchen Sie es zu einem sp�teren
   * Zeitpunkt erneut.<br>
   * ORCLI-Code: ZS-08006
   */
